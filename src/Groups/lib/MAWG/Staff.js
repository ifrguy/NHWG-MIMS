// Staff group (anyone in the unit with a duty assignment)
...
function makePipeline(unit, domain, groupname)
{
  let pipeline =
      [
        // No initial $match so it uses the entirety of DutyPosition
      ];
...
export default class extends Group
{
  constructor(db, groupname, unit = "")
  {
	...
	super( db, config.domain, groupname, pipeline, pipeline_start, true );
  }
}
